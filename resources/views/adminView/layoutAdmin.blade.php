...
<html lang="en">
  <head>
    ...
    <script src="{{asset("admin/assets/js/jquery-3.js")}}"></script>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url("admin/index")}}">
                <span class="menu-title">Dashboard Index</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url("admin/brandIndex")}}">
                <span class="menu-title">Brand Manage</span>
                <i class="mdi mdi-contacts menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url("admin/categoriesIndex")}}">
                <span class="menu-title">Categories Manage</span>
                <i class="mdi mdi-contacts menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url("admin/productIndex")}}">
                <span class="menu-title">Product Manage</span>
                <i class="mdi mdi-contacts menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url("admin/userIndex")}}">
