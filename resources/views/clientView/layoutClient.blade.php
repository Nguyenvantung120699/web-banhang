...
@include('clientView.htmlLayout.head')

<body>

    @include('clientView.htmlLayout.header')

    @yield('content')

    @includeFirst(['clientView.htmlLayout.footer','footer'])
	 <!-- Modal -->
	 @include('clientView.htmlLayout.modalLogin')
